...
/* Symbols to be used with PORT driver */
#define I2C_INITPINS_XTAL_SCL_PORT PORTA               /*!<@brief PORT peripheral base pointer */
#define I2C_INITPINS_XTAL_SCL_PIN 8U                   /*!<@brief PORT pin number */
#define I2C_INITPINS_XTAL_SCL_PIN_MASK (1U << 8U)      /*!<@brief PORT pin mask */
                                                       /* @} */
...
/* Symbols to be used with PORT driver */
#define I2C_INITPINS_XTAL_SDA_PORT PORTA               /*!<@brief PORT peripheral base pointer */
#define I2C_INITPINS_XTAL_SDA_PIN 9U                   /*!<@brief PORT pin number */
#define I2C_INITPINS_XTAL_SDA_PIN_MASK (1U << 9U)      /*!<@brief PORT pin mask */
                                                       /* @} */
